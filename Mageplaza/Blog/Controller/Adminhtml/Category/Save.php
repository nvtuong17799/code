...
class Save extends Category
{
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('category')) {
            ...
            $this->prepareData($category, $data);
...
//            $category->addData($data);
    ...
    protected function prepareData($category, $data = [])
    {
        if (!$this->getRequest()->getParam('image')) {
            try {
                $this->imageHelper->uploadImage($data, 'image', Image::TEMPLATE_MEDIA_TYPE_CATEGORY, $category->getImage());
