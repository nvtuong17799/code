...
use Mageplaza\Blog\Helper\Email as HelperEmail;
...
class InlineEdit extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $comment->save();
            if($this->helperBlog->getEmailConfig('enable_notification') == 1 && $comment->getStatus() == 1){
                    $this->helperEmail->sendEmail($comment);
            }
