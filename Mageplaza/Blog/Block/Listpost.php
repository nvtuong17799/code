...
class Listpost extends Frontend
{
     ...
     * @return mixed
     */
    public function getBlogPerRow()
    {
        return $this->helperData->getBlogConfig('general/blog_per_row');
    }

    public function isSlider(){
        return $this->helperData->getBlogConfig('general/display_style') == DisplayType::SLIDER;
    }
