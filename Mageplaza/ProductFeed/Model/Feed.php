 ...
 * @method getProtocol()
 * @method getConditonsProductType()
 */
        ...
        if ($this->productIds === null) {
            ...
            if(array_key_exists('conditions', $conditions)){
                foreach ($conditions['conditions'] as $condition){
                    if($condition['attribute'] === 'type_id'){
                        $productCollection->addFieldToFilter('type_id', $condition['value']);
                        if ($condition['value'] !== 'simple'){
                            foreach($productCollection as $_product) {
                                $childrenIds = $_product->getTypeInstance()->getChildrenIds($_product->getId(), true);
            ...
            $this->setConditionsSerialized($this->helperData->serialize($conditions));
